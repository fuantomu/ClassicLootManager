...
-- Modules/GUI/UnifiedGUI_Standings.lua:365
CLM.L["Att. [%]"] = "Anwes. [%]"
CLM.L["Att. last raid"] = "Anwes. letzter Raid"
-- Modules/RosterManager/RosterManager.lua:382
